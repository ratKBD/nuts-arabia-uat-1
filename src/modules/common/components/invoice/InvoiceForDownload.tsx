...
const InvoiceForDownload = ({ data }: any) => {
  return (
    <>
      <Document>
        <Page size="A4" style={styles.page}>
          <View style={styles.invoiceFirst}>
            ...
            <View>
              <Image
                style={styles.logo}
                /* src={logo} */ src="/logo/logo-color.png"
              />
              <Text style={styles.info}>
          ...
          <View style={styles.invoiceSecond}>
            <View>
              ...
              <Text style={styles.info}>
                {data.shipping_address.created_at !== undefined && (
                  <span>
            ...
            <View>
              ...
              <Text style={styles.info}>
                {" "}
                {data.shipping_address.address_1 /* .substring(0, 25) */}
              </Text>
              <Text style={styles.info}>
                {data.city}, {data.shipping_address.country},{" "}

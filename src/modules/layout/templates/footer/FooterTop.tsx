...
const FooterTop = () => {
  return (
    <div
      id="downloadApp"
      className=" py-10 lg:py-16 bg-repeat bg-center overflow-hidden" style={{background:"#FFF3E1"}}
    >
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-2 md:gap-3 lg:gap-3 items-center">
          ...
          <div className="text-center">
            <h3 className="text-lg md:text-xl lg:text-2xl font-bold font-serif mb-3">
              Get Your Daily Needs From Our NutsArabia Store
            </h3>
            <p className="text-base opacity-90 leading-7">
              There are many products you will find our shop, Choose your daily
              necessary product from our NutsArabia shop and get some special
              offer.
            </p>
            <div className="mt-8">
